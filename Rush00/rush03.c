...
/*   Updated: 2020/11/22 21:32:14 by cfico-vi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
**this function builds the first and the last line of the form choosing which**
**char to put in each space, using the counter in relation with the number of**
**columns inputted (y).**
*/

int			first_last_x(int g_count_y, int y)
{
	if (g_count_y == 0)
	{
		ft_putchar('A');
